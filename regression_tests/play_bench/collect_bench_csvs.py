...
DEFAULT_PLATFORM = "PULPCLUSTER"
DEFAULT_RESULTS_DIR = "PLAY/test/runners/pulp-open/benchmarks/rtl/results"     # relative to the repo root
DEFAULT_SUFFIX_FMT = "_CL_{cores}.csv"       # e.g. "_MAGIA_CL_{cores}.csv"
DEFAULT_ROOT_UP = ()               # the script sits in play_bench/ itself
