...
set ROOT "/data2/luca.colombo/physical/pulp_GF12"
...
if {0 == [analyze -format sv \
    -define { \
        TARGET_CLUSTER_STANDALONE \
        TARGET_CV32E40P_USE_FF_REGFILE \
        TARGET_MCHAN \
        TARGET_PULP_STANDALONE_SYNTH \
        TARGET_RTL \
        TARGET_SCM_USE_FPGA_SCM \
        TARGET_SYNOPSYS \
        TARGET_SYNTHESIS \
        FEATURE_ICACHE_STAT \
        PRIVATE_ICACHE \
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
...
if {0 == [analyze -format sv \
    ...
    [list \
        ...
        "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/src/credit_counter.sv" \
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/apb-a9fe5d9ed5687f05/include"
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/axi-f34f593106290a7f/include"
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
...
if {0 == [analyze -format sv \
    ...
    [list \
        ...
        "$ROOT/.bender/git/checkouts/axi-f34f593106290a7f/src/axi_burst_splitter_gran.sv" \
        "$ROOT/.bender/git/checkouts/axi-f34f593106290a7f/src/axi_burst_unwrap.sv" \
        ...
        "$ROOT/.bender/git/checkouts/axi-f34f593106290a7f/src/axi_fifo_delay_dyn.sv" \
        ...
        "$ROOT/.bender/git/checkouts/axi-f34f593106290a7f/src/axi_zero_mem.sv" \
        "$ROOT/.bender/git/checkouts/axi-f34f593106290a7f/src/axi_interleaved_xbar.sv" \
        ...
        "$ROOT/.bender/git/checkouts/axi-f34f593106290a7f/src/axi_xbar_unmuxed.sv" \
...
lappend search_path "$ROOT/.bender/git/checkouts/axi-f34f593106290a7f/include"
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
lappend search_path "$ROOT/.bender/git/checkouts/register_interface-96e1aa763449594f/include"
...
if {0 == [analyze -format sv \
    ...
    [list \
        ...
        "$ROOT/.bender/git/checkouts/register_interface-96e1aa763449594f/src/axi_to_reg_v2.sv" \
        ...
        "$ROOT/.bender/git/checkouts/register_interface-96e1aa763449594f/src/reg_cut.sv" \
        ...
        "$ROOT/.bender/git/checkouts/register_interface-96e1aa763449594f/src/reg_to_axi.sv" \
        ...
        "$ROOT/.bender/git/checkouts/register_interface-96e1aa763449594f/src/deprecated/axi_to_reg.sv" \
    ]
]} {return 1}

set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/cluster_interconnect-9a146c2c6998a1b5/rtl/low_latency_interco"
lappend search_path "$ROOT/.bender/git/checkouts/cluster_interconnect-9a146c2c6998a1b5/rtl/peripheral_interco"
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/hwpe-stream-bc1f2d87c271f75a/rtl"
...
if {0 == [analyze -format sv \
    ...
    [list \
        ...
        "$ROOT/.bender/git/checkouts/redundancy_cells-5efefdcf7db23b80/rtl/ecc_wrap/ecc_sram.sv" \
    ]
]} {return 1}

set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
lappend search_path "$ROOT/.bender/git/checkouts/redundancy_cells-5efefdcf7db23b80/rtl/ODRG_unit"
lappend search_path "$ROOT/.bender/git/checkouts/register_interface-96e1aa763449594f/include"
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
lappend search_path "$ROOT/.bender/git/checkouts/redundancy_cells-5efefdcf7db23b80/rtl/pulpissimo_tcls"
lappend search_path "$ROOT/.bender/git/checkouts/register_interface-96e1aa763449594f/include"
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/axi_stream-c292b04b7e4bd2f3/include"
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/axi_stream-c292b04b7e4bd2f3/src/axi_stream_intf.sv" \
        "$ROOT/.bender/git/checkouts/axi_stream-c292b04b7e4bd2f3/src/axi_stream_cut.sv" \
        "$ROOT/.bender/git/checkouts/axi_stream-c292b04b7e4bd2f3/src/axi_stream_dw_downsizer.sv" \
        "$ROOT/.bender/git/checkouts/axi_stream-c292b04b7e4bd2f3/src/axi_stream_dw_upsizer.sv" \
        "$ROOT/.bender/git/checkouts/axi_stream-c292b04b7e4bd2f3/src/axi_stream_multicut.sv" \
    ]
]} {return 1}

set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
lappend search_path "$ROOT/.bender/git/checkouts/cv32e40p-35b87d405a0b7598/bhv"
lappend search_path "$ROOT/.bender/git/checkouts/cv32e40p-35b87d405a0b7598/rtl/include"
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/sva"
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/include/cv32e40x_pkg.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/bhv/cv32e40x_sim_clock_gate.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_if_c_obi.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_if_xif.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_pma.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_prefetcher.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_alignment_buffer.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_i_decoder.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_a_decoder.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_b_decoder.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_m_decoder.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_ff_one.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_alu_b_cpop.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_popcnt.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_prefetch_unit.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_compressed_decoder.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_instr_obi_interface.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_mpu.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_sequencer.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_pc_target.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_decoder.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_alu.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_div.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_mult.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_wpt.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_align_check.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_lsu_response_filter.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_write_buffer.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_data_obi_interface.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_csr.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_debug_triggers.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_controller_fsm.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_controller_bypass.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_register_file.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_sleep_unit.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_if_stage.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_id_stage.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_ex_stage.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_load_store_unit.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_wb_stage.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_cs_registers.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_controller.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_clic_int_controller.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_int_controller.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_register_file_wrapper.sv" \
        "$ROOT/.bender/git/checkouts/cv32e40x-b103eeedbf7ffce6/rtl/cv32e40x_core.sv" \
    ]
]} {return 1}
...
lappend search_path "$ROOT/.bender/git/checkouts/cluster_interconnect-9a146c2c6998a1b5/rtl/peripheral_interco"
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
lappend search_path "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/common"
lappend search_path "$ROOT/.bender/git/checkouts/register_interface-96e1aa763449594f/include"
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/common/hci_package.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/ecc/hci_ecc_manager_reg_pkg.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/common/hci_interfaces.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/ecc/hci_ecc_manager_reg_top.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_assign.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_assign_expand.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_cut.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_fifo.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_mux_dynamic.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_mux_static.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_mux_ooo.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_r_valid_filter.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_r_id_filter.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_source.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_split.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/ecc/hci_ecc_dec.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/ecc/hci_ecc_enc.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/ecc/hci_ecc_manager.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/interco/hci_log_interconnect.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/interco/hci_log_interconnect_l2.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/interco/hci_new_log_interconnect.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/interco/hci_arbiter.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/interco/hci_arbiter_tree.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/interco/hci_router_reorder.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/parity/hci_copy_source.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/parity/hci_copy_sink.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/core/hci_core_sink.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/ecc/hci_ecc_source.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/interco/hci_router.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/ecc/hci_ecc_interconnect.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/ecc/hci_ecc_sink.sv" \
        "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/hci_interconnect.sv" \
    ]
]} {return 1}

set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/hwpe-ctrl-f0ffa31ac61ad2d6/rtl"
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/ibex-ea88d7e2212bdc23/rtl"
lappend search_path "$ROOT/.bender/git/checkouts/ibex-ea88d7e2212bdc23/vendor/lowrisc_ip/ip/prim/rtl"
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
lappend search_path "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/include"
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/obi_pkg.sv" \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/obi_intf.sv" \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/obi_rready_converter.sv" \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/apb_to_obi.sv" \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/obi_atop_resolver.sv" \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/obi_cut.sv" \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/obi_demux.sv" \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/obi_err_sbr.sv" \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/obi_mux.sv" \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/obi_sram_shim.sv" \
        "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/src/obi_xbar.sv" \
    ]
]} {return 1}
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/include/"
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/include/zeroriscy_defines.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/include/zeroriscy_tracer_defines.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_alu.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_compressed_decoder.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_controller.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_cs_registers.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_debug_unit.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_decoder.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_int_controller.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_ex_block.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_register_file.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_id_stage.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_if_stage.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_load_store_unit.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_multdiv_slow.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_multdiv_fast.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_prefetch_buffer.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_fetch_fifo.sv" \
        "$ROOT/.bender/git/checkouts/zeroriscy-22c2b21b66a80359/zeroriscy_core.sv" \
    ]
]} {return 1}
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/snitch_icache_pkg.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/riscv_instr_branch.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/multi_accept_rr_arb.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/snitch_axi_to_cache.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/snitch_icache_l0.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/snitch_icache_refill.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/snitch_icache_lfsr.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/snitch_icache_lookup_parallel.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/snitch_icache_lookup_serial.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/snitch_icache_handler.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/snitch_icache.sv" \
        "$ROOT/.bender/git/checkouts/cluster_icache-4c46e02016343694/src/snitch_read_only_cache.sv" \
    ]
]} {return 1}
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/cluster_peripherals-45e4f8f679514447/event_unit/include"
lappend search_path "$ROOT/.bender/git/checkouts/hci-43f23d0c892bcf9b/rtl/common"
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
lappend search_path "$ROOT/.bender/git/checkouts/event_unit_flex-915b40dfa1db7f9f/rtl"
...
set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/include"
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/include/apu_core_package.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/include/riscv_defines.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/include/riscv_tracer_defines.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/macload_controller.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/mixed_precision_controller.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_alu.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_alu_basic.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_alu_div.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_compressed_decoder.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_controller.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_cs_registers.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_decoder.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_int_controller.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_ex_stage.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_hwloop_controller.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_hwloop_regs.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/register_file_test_wrap.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_id_stage.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_if_stage.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_load_store_unit.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_mult.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_prefetch_buffer.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_prefetch_L0_buffer.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_core.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_apu_disp.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_fetch_fifo.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_L0_buffer.sv" \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_pmp.sv" \
    ]
]} {return 1}
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/flex-v-c8050960b63bda8b/rtl/riscv_register_file.sv" \
    ]
]} {return 1}
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/FP_WRAP/fp_iter_divsqrt_msv_wrapper_2_STAGE.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/FP_WRAP/fpnew_wrapper.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/AddressDecoder_Resp_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/FanInPrimitive_Req_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/FanInPrimitive_Resp_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/FPU_clock_gating.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/fpu_demux.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/LFSR_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/optimal_alloc.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/RR_Flag_Req_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/AddressDecoder_Req_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/ArbitrationTree_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/RequestBlock_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/ResponseTree_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/ResponseBlock_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/XBAR_FPU.sv" \
        "$ROOT/.bender/git/checkouts/fpu_interco-66f11b059cd1efc8/RTL/shared_fpu_cluster.sv" \
    ]
]} {return 1}
...
lappend search_path "$ROOT/.bender/git/checkouts/axi_stream-c292b04b7e4bd2f3/include"
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
lappend search_path "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/include"
lappend search_path "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/target/rtl/include"
lappend search_path "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/test"
lappend search_path "$ROOT/.bender/git/checkouts/obi-dbee7a6a9c06bc88/include"
lappend search_path "$ROOT/.bender/git/checkouts/register_interface-96e1aa763449594f/include"
...
if {0 == [analyze -format sv \
    ...
    [list \
        ...
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_axil_read.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_axil_write.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_axi_read.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_axi_write.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_axis_read.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_axis_write.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_channel_coupler.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_dataflow_element.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_error_handler.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_init_read.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_init_write.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_legalizer_page_splitter.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_legalizer_pow2_splitter.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_obi_read.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_obi_write.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_tilelink_read.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/backend/idma_tilelink_write.sv" \
    ]
]} {return 1}
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/target/rtl/idma_generated.sv" \
    ]
]} {return 1}
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/midend/idma_mp_dist_midend.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/midend/idma_mp_split_midend.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/midend/idma_nd_midend.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/midend/idma_rt_midend.sv" \
    ]
]} {return 1}
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/frontend/desc64/idma_desc64_ar_gen.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/frontend/desc64/idma_desc64_ar_gen_prefetch.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/frontend/desc64/idma_desc64_reader.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/frontend/desc64/idma_desc64_reader_gater.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/frontend/desc64/idma_desc64_reshaper.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/frontend/idma_transfer_id_gen.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/frontend/desc64/idma_desc64_reg_wrapper.sv" \
        "$ROOT/.bender/git/checkouts/idma-56b9ad1d44bf0812/src/frontend/desc64/idma_desc64_top.sv" \
    ]
]} {return 1}

set search_path $search_path_initial
lappend search_path "$ROOT/.bender/git/checkouts/common_cells-5a98055a67ec8079/include"
lappend search_path "$ROOT/.bender/git/checkouts/mchan-9c1d6ff87a51f443/rtl/include"
...
if {0 == [analyze -format sv \
    ...
    [list \
        ...
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/redmule_tiler.sv" \
        ...
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/x_buffer/redmule_x_buffer.sv" \
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/x_buffer/redmule_x_pad_scm.sv" \
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/x_buffer/redmule_x_buffer_scm.sv" \
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/w_buffer/redmule_w_buffer.sv" \
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/w_buffer/redmule_w_buffer_scm.sv" \
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/z_buffer/redmule_z_buffer.sv" \
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/z_buffer/redmule_z_buffer_scm.sv" \
        ...
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/redmule_inst_decoder.sv" \
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/redmule_top.sv" \
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/redmule_memory_scheduler.sv" \
        "$ROOT/.bender/git/checkouts/redmule-8ba8e6c90026f85e/rtl/redmule_complex.sv" \
    ]
]} {return 1}
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_pkg.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_fp_red_minmax.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_fp_minmax_rec.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_fp_red_sum.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_fp_add_rec.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_pipeline.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_delay.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_fp_glob_minmax.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_datapath.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_fp_vect_addmul.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_streamer.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_streamer_strb_gen.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_cast_in.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_cast_out.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_top.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_ctrl.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_slot_regfile.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/softex_wrap.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/expu/expu_correction.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/expu/expu_row.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/expu/expu_schraudolph.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/expu/expu_top.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/accumulator/softex_acc_ctrl.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/accumulator/softex_acc_datapath.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/accumulator/softex_acc_top.sv" \
        "$ROOT/.bender/git/checkouts/softex-072d4544ec438dd0/rtl/accumulator/softex_acc_den_inverter.sv" \
    ]
]} {return 1}
...
if {0 == [analyze -format sv \
    ...
    [list \
        "$ROOT/nonfree/gf12/mems/tc_sram.sv" \
        "$ROOT/nonfree/gf12/sourcecode/tc_clk.sv" \
    ]
]} {return 1}
